...
public class Comandos {
    ...
    static {                                              
        ...
        LISTA.add(new String[]{"20", "INSINC", "Inscribir estudiante",   "id_estudiante, id_curso, id_plan_pago",          "INSINC[\"2\",\"1\",\"1\"]"});
        LISTA.add(new String[]{"21", "MODINC", "Actualizar inscripcion", "id, estado (programada/cursada/cancelada)",                               "MODINC[\"1\",\"cursada\"]"});
        ...
        LISTA.add(new String[]{"24", "INSCRT", "Registrar certificacion (nota >= 70 emite cert, < 70 libera curso sin cert)", "id_inscripcion, nota, estado, fecha_emision (YYYY-MM-DD)", "INSCRT[\"1\",\"85\",\"aprobado\",\"2025-08-15\"]"});
        ...
        LISTA.add(new String[]{"28", "INSPAG", "Registrar pago",       "id_inscripcion, id_metodo (1=Efectivo, 2=QR)",                               "INSPAG[\"1\",\"1\"]"});
        ...
        // Reserva de cursos (CU-09)
        LISTA.add(new String[]{"29", "LISRES", "Ver cursos disponibles para reservar", "*",                              "LISRES[\"*\"]"});
        LISTA.add(new String[]{"30", "INSRES", "Reservar un curso",                    "id_curso, id_estudiante",        "INSRES[\"1\",\"5\"]"});
        LISTA.add(new String[]{"31", "DELRES", "Cancelar reserva",                     "id_curso, id_estudiante",        "DELRES[\"1\",\"5\"]"});
        // Reportes y Estadísticas (solo lectura)
        LISTA.add(new String[]{"33", "REPUSU", "Reporte usuarios por rol/estado",         "*", "REPUSU[\"*\"]"});
        LISTA.add(new String[]{"34", "REPVEH", "Reporte vehículos por tipo/estado",       "*", "REPVEH[\"*\"]"});
        LISTA.add(new String[]{"35", "REPINS", "Reporte inscripciones por tipo de curso", "*", "REPINS[\"*\"]"});
    ...
    public static final String[] HEADERS_FLUJO = {"ID", "COMANDO", "DESCRIPCION", "PARAMETROS", "EJEMPLO"};
